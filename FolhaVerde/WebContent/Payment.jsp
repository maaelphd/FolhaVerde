	...
	<div id="wrapper">
		...
		<div id="divPageContent">		
							...
							<div class="CardForm">
									...
									<div class="PaymentCardFlags clearfix form-inline">
										<p class="card-flags active">
											...
											<label class="radio card-flag-label" for="creditCardselectedCard1cc-0" title="American Express">
												<input type="radio" class="card-flag-radio" id="creditCardselectedCard1cc-0" name="creditCardselectedCardFlag-0" tabindex="-1" value="1">
											...
											<label class="radio card-flag-label" for="creditCardselectedCard2cc-0" title="Hipercard">
												<input type="radio" class="card-flag-radio" id="creditCardselectedCard2cc-0" name="creditCardselectedCardFlag-0" tabindex="-1" value="8">
											...
											<label class="radio card-flag-label" for="creditCardselectedCard3cc-0" title="Diners">
												<input type="radio" class="card-flag-radio" id="creditCardselectedCard3cc-0" name="creditCardselectedCardFlag-0" tabindex="-1" value="3">
											...
											<label class="radio card-flag-label" for="creditCardselectedCard4cc-0" title="Elo">
												<input type="radio" class="card-flag-radio" id="creditCardselectedCard4cc-0" name="creditCardselectedCardFlag-0" tabindex="-1" value="9">
												<span class="card-flag Elo ">Elo</span>
											</label>
											<label class="radio card-flag-label" for="creditCardselectedCard5cc-0" title="Mastercard">
												<input type="radio" class="card-flag-radio" id="creditCardselectedCard5cc-0" name="creditCardselectedCardFlag-0" tabindex="-1" value="4">
								...
								<div>
									<p class="PaymentCardHolderName">
										...
										<input type="text" class="input-medium  " id="creditCardpayment-card-0Name" name="ccName" value="">
									</p>
								...
								<p class="PaymentCardCVV input text required">
									...
									<input type="tel" id="creditCardpayment-card-0Code" class="input-mini   " maxlength="3" value="">
								</p>
								<p class="PaymentCardHolderDocument input text required mask">
									...
									<input type="tel" id="holder-document-0" class="input-small  " value="" placeholder="999.999.999-99">
								</p>
							</div>	
						</td>
					</tr>			
			...
			<div class="btn buttonsDiv" align="center">
				<button type="button" autofocus>Confirmar</button>
			</div>
		</div>
